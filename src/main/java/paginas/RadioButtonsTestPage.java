...
public class RadioButtonsTestPage {
    ...
    public RadioButtonsTestPage testarRadioButtonSimples(String gender) {
        ...
        navegador.findElement(By.xpath("//input[@value='"+gender+"'][@name='optradio']")).click();
        navegador.findElement(By.id("buttoncheck")).click();
        String msg = navegador.findElement(By.cssSelector("p[class='radiobutton']")).getText();
        Assertions.assertEquals("Radio button '"+gender+"' is checked",msg);
